<template>
  ...
  <el-tooltip v-else-if="isTopLevel" :content="item.meta?.title || item.name" placement="right" :disabled="!isCollapsed">
...
const menuCollapsed = inject<ComputedRef<boolean>>('menuCollapsed', computed(() => false))
