  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'system/role/list', name: 'roleList', component: RoleList, meta: { title: '角色列表' } },
        { path: 'system/role/permission', name: 'rolePermission', component: RolePermission, meta: { title: '权限配置' } }
      ]
    },
